...
function forwardStaticMembers(Extended, Original, Super) {
  ...
  Object.getOwnPropertyNames(Original).forEach(function (key) {
    ...
    if (!hasProto$1) {
      ...
      if (
        !isPrimitive$1(descriptor.value) &&
        superDescriptor &&
...
__decorate([Prop()], SwButton.prototype, 'to', void 0)
__decorate(
...
__decorate([Emit('click')], SwButton.prototype, 'click', null)
SwButton = __decorate([Component], SwButton)
var script = SwButton
...
const __vue_inject_styles__ = function (inject) {
  if (!inject) return
  inject('data-v-d6e0ec30_0', {
    source: '\n\n/*# sourceMappingURL=sw-button.vue.map */',
    map: {
      version: 3,
      sources: ['sw-button.vue'],
      names: [],
      mappings: ';;AAEA,wCAAwC',
      file: 'sw-button.vue',
    },
    media: undefined,
  })
...
/* scoped */
const __vue_scope_id__ = 'data-v-d6e0ec30'
/* module identifier */
